...
export function cast(t, H) {
  ...
  // ===== ENFANT =====
  {
    ...
    const PLAY = (u, k = 1) => ({ ...HL(0.065, 0.33, 0.3, 0.2), ...HR(-0.065, 0.33 + 0.012 * Math.sin(u * 13) * k, 0.3, 0.2), neckX: 0.32, lookW: 0.9, lWrX: -0.2, rWrX: -0.2, lWrZ: -0.4, rWrZ: 0.4 });
    const p = layer(t, SIT(s, 0.28, 0.5), [
      [0, 17.2, (u) => PLAY(u)],
      [17.2, 20.2, (u) => ({ ...PLAY(u, 0), neckX: 0, ...HL(0.07, 0.26, 0.28, 0.2), ...HR(-0.07, 0.26, 0.28, 0.2) })],
      [20.2, 22.6, { ...PLAY(0, 0), spineZ: 0.36, spineY: 0.3, ...HL(-0.12, 0.34, 0.22), ...HR(-0.3, 0.36, 0.16, 0.3), neckX: 0.1 }, 0.2],
      [22.6, 27.9, (u) => PLAY(u)],
      [27.9, 29.45, { ...WR(...BAG_TOP), spineX: 0.5, spineZ: 0.3, neckX: 0.25, ...HL(0.16, 0.28, 0.5) }, 0.3],
      [29.45, 30.6, { ...WR(TABLE_SPK[0], TABLE_SPK[1] - 0.03, TABLE_SPK[2]), spineX: 0.25, ...HL(0.16, 0.28, 0.5) }, 0.25],
      ...
      [58.3, 72, (u) => ({ ...HR(0.1, 0.74 + 0.02 * Math.sin(u * 3), 0.3, 0.3), rWrX: 0.2, ...HL(0.16, 0.28, 0.5), spineY: 0.28, spineZ: -0.08 })],
    ]);
    let look = null;
