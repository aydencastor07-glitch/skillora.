...
def gen_blueprint(idea, source_url=None):
    ...
    charter = (
        ...
        "RÈGLES D'OR DE L'ANIMATION (tu es Gemini, Veo est TON modèle Google — "
        "tu connais ses défauts, écris les prompts qui les évitent) :\n"
        "1. JAMAIS de référence vague : à CHAQUE mention d'un personnage dans le "
        "prompt, redonne sa DESCRIPTION PHYSIQUE complète (« the rich banana-man "
        "in the elegant white suit », « the small cucumber boy in brown rags and "
        "a red scarf »). INTERDIT d'écrire « the kid », « the man », « he/she » "
        "seuls — c'est comme ça que Veo confond les personnages.\n"
        "2. PAROLE = un bloc complet : QUI (description complète) + LA VOIX "
        "(deep raspy male voice, soft young female voice…) + le TON (smug, "
        "cruel, joyful, mocking…) + la réplique exacte + l'action "
        "SIMULTANÉE. Si la parole accompagne un geste, ils se font EN MÊME "
        "TEMPS : « WHILE saying \"Tiens\", the rich banana-man in the white "
        "suit pulls a banknote from his pocket and hands it to the cucumber "
        "boy ». Jamais la parole puis le geste 3 secondes plus tard.\n"
        "3. QUI PARLE : Veo fait parler le MAUVAIS perso quand il y en a "
        "plusieurs. Fige les non-parleurs : « the cucumber boy stays silent, "
        "mouth closed, listening. Only the banana-man's lips move ».\n"
        "4. CAMÉRA à chaque beat : où elle est, qui elle cadre, son mouvement "
        "(static / slow zoom-in on the speaker / pan). Tu PEUX dévier un peu de "
        "la vidéo source (ex : zoom sur le parleur) si ça rend la scène plus "
        "claire — on copie l'esprit, pas au pixel.\n"
        "5. ORDRE EXPLICITE : chaque geste est AVANT, PENDANT ou APRÈS une "
        "réplique (WHILE / AFTER / BEFORE). Jamais d'ordre implicite.\n"
        "6. PAS DE SURCHARGE : max 3-4 actions par clip de 8 s, sinon Veo en "
        "saute -> découpe en un 2e plan de la même image.\n"
        "7. PERSONNAGES PRÉSENTS UNIQUEMENT : ne mentionne QUE les personnages "
        "réellement dans la scène. S'il n'y a pas de femme, n'écris JAMAIS « the "
        "woman » (Veo l'ajouterait). Précise « only these N characters are in "
        "the scene ».\n"
        "8. VERROUS finaux : « no new characters, no character changes, "
        "characters keep the exact same appearance, the camera does not cut ».\n"
