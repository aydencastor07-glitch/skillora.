...
def gen_blueprint(idea, source_url=None):
    ...
    charter = (
        ...
        "2. PAROLE = un bloc complet : QUI (description complète) + le TON de la "
        "voix (smug, cruel, joyful, mocking…) + la réplique exacte + l'action "
        ...
        "7. VERROUS finaux : « no new characters, no character changes, "
        "characters keep the exact same appearance, the camera does not cut ».\n"
        "8. Une seule réplique à la fois (jamais 2 persos qui parlent "
        "ensemble).\n\n"
