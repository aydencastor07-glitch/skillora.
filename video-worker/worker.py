...
def gen_blueprint(idea, source_url=None):
    ...
    charter = (
        ...
        "humain (« man », « woman », « boy », « kid ») — Veo le transformerait "
        "en humain (visage humain, bras humains). Décris l'ESPÈCE exacte : "
        "« the tall blackened banana character with a full banana body and "
        "cartoon googly eyes — not a human, no human face, no human skin ».\n"
