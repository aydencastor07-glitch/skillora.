...
def gen_blueprint(idea, source_url=None):
    ...
    charter = (
        ...
        "1. JAMAIS de référence vague : à CHAQUE mention d'un personnage, "
        "redonne sa DESCRIPTION PHYSIQUE complète (« the rich banana-man in "
        "the elegant white suit »). INTERDIT d'écrire « the kid », « the man », "
        "« he/she » seuls — c'est comme ça que Veo confond les personnages.\n"
