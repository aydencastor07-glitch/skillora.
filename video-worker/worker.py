...
def gen_blueprint(idea, source_url=None):
    ...
    charter = (
        ...
        "RÈGLES ANTI-BUG VEO (tu es Gemini, Veo est TON modèle Google — tu "
        "connais ses défauts, écris les prompts qui les évitent) :\n"
        "1. QUI PARLE : Veo fait souvent parler le MAUVAIS personnage quand il "
        "y en a plusieurs. Désigne TOUJOURS le parleur par son APPARENCE (« the "
        "woman in the red dress says… »), et fige les autres : « the man stays "
        "silent, mouth closed, listening ». Only her lips move.\n"
        "2. ORDRE EXPLICITE : dis si un geste arrive AVANT, PENDANT ou APRÈS la "
        "réplique (« WHILE saying this, he reaches into his pocket » / « AFTER "
        "she finishes speaking, he stands up »). Jamais d'ordre implicite.\n"
        "3. PAS DE SURCHARGE : max 3-4 actions par clip de 8 s. Trop de beats = "
        "Veo en saute. Si la scène a plus d'actions, découpe en un 2e plan de "
        "la même image.\n"
        "4. VERROUS : termine chaque animation_prompt par les interdits : « no "
        "new characters, no character changes, characters keep the exact same "
        "appearance, the camera does not cut ».\n"
        "5. Une seule réplique à la fois : jamais deux personnages qui parlent "
        "en même temps dans un même clip.\n\n"
